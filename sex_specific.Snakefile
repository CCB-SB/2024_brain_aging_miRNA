...
#         groups=config["mirna_number_per_tissue_bar_plot"].get("groups", None),
...
rule diff_exp_CA1_without_pon:
    input:
    output: result=join(config["results_folder"], get_steps_folder("diff_exp_CA1_without_pon"))
    params: 
        data_input=config["common"].get("input", None),
        parameters_props=config["common"].get("parameters", None),
        comparisons_supp_table=config["diff_exp_CA1"].get("comparisons", None),
        comparisons_volcano_age=config["volcano_scatter_plot"].get("comparisons_age_without_pon", None),
        comparisons_volcano_brain_region=config["volcano_scatter_plot"].get("comparisons_brain_region_without_pon", None),
        log_list=config["diff_exp_CA1"].get("log_list", None),
        adjustment=config["diff_exp_CA1"]["adjustment"],
        results_folder=config["results_folder"]
    conda: "envs/analysis_packages.yml"
...
rule diff_exp_CA1_without_age_26m_28m:
    ...
    params: 
        ...
        parameters_props=config["common"].get("parameters", None),
        comparisons_volcano_brain_region=config["volcano_scatter_plot"].get("comparisons_brain_region", None),
        comparisons_supp_table=config["diff_exp_CA1_without_age_26m_28m"].get("comparisons", None),
        comparisons_volcano_age=config["volcano_scatter_plot"].get("comparisons_age_without_age_26m_28m", None),
        comparisons_fc_age=config["fc_versus_expr_scatter_plot"].get("comparisons_CA1_without_age_26m_28m", None),
        log_list=config["diff_exp_CA1_without_age_26m_28m"].get("log_list", None),
        adjustment=config["diff_exp_CA1_without_age_26m_28m"]["adjustment"],
        results_folder=config["results_folder"]
    conda: "envs/analysis_packages.yml"
    script: "scripts/diff_exp.R"

rule diff_exp_CA1_without_age_26m_28m_without_pon:
    input:
    output: result=join(config["results_folder"], get_steps_folder("diff_exp_CA1_without_age_26m_28m_without_pon"))
    params: 
        data_input=config["common"].get("input", None),
        parameters_props=config["common"].get("parameters", None),
        comparisons_volcano_brain_region=config["volcano_scatter_plot"].get("comparisons_brain_region_without_pon", None),
        comparisons_supp_table=config["diff_exp_CA1_without_age_26m_28m"].get("comparisons", None),
        comparisons_volcano_age=config["volcano_scatter_plot"].get("comparisons_age_without_age_26m_28m_without_pon", None),
        comparisons_fc_age=config["fc_versus_expr_scatter_plot"].get("comparisons_CA1_without_age_26m_28m_without_pon", None),
        log_list=config["diff_exp_CA1_without_age_26m_28m"].get("log_list", None),
        adjustment=config["diff_exp_CA1_without_age_26m_28m"]["adjustment"],
        results_folder=config["results_folder"]
    conda: "envs/analysis_packages.yml"
...
rule volcano_CA1_without_age_26m_28m_scatter_plot:
    ...
    params: 
        ...
        diff_log=config["fc_versus_expr_scatter_plot"].get("diff_log", None),
        comparisons_brain_region=config["volcano_scatter_plot"].get("comparisons_brain_region", None),
        comparisons_age=config["volcano_scatter_plot"].get("comparisons_age_without_26m_28m", None),
        parameters=config["volcano_scatter_plot"].get("parameters", None),
        colors=config["colors"],
        plots_props=config["common"].get("plots", None),
        results_folder=config["results_folder"]
...
# rule correlation_comp_age_per_rna_class_male_female_scatter_plot:
#     input: 
#     output: result=join(config["results_folder"], get_steps_folder("correlation_comp_age_per_rna_class_male_female_scatter_plot"))
#     params:
#         data_input=config["common"].get("input", None),
#         parameters_props=config["common"].get("parameters", None),
#         prop_attribute=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("props", None),
#         corr_methods=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("method", None),
#         corr_th=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("corr_th", None),
#         p_val_adj=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("adjustment", None),
#         adj_p_value=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("adj_p_value", None),
#         rna_class=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("rna_class", None),
#         plot_size=config["correlation_comp_age_per_rna_class_male_female_scatter_plot"].get("plot_size", None),
#         xticks_names=config["xticks_names"],
#         colors=config["colors"],
#         plots_props=config["common"].get("plots", None),
#         results_folder=config["results_folder"]
#     conda: "envs/analysis_packages.yml"
#     script: "scripts/correlation_comp_age_per_rna_class_male_female_scatter_plot.R"
