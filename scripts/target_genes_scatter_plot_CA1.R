...
#snakemake = readRDS("snakemake_target_genes_scatter_plot_CA1.rds")

set.seed(snakemake@params$parameters_props$set_seed)

print("target_genes_scatter_plot_CA1")
...
# save rdata
#saveRDS(snakemake, file = "snakemake_target_genes_scatter_plot_CA1.rds")
...
y_lab_title_tall = "Gene expression values (Hahn et al.) for CAS"
y_lab_title_small = "Gene expression values\n(Hahn et al.) for CAS"
