...
} else if (data_sub_set == "CA1_male") {
  comps = snakemake@params$comparisons_CA1
} else if (data_sub_set == "CA1_female") {
  comps = snakemake@params$comparisons_CA1
} else if (data_sub_set == "CA1_age=3m_12m_15m") {
  comps = snakemake@params$comparisons_CA1_age_3m_12m_15m
} else if (data_sub_set == "CA1_age=3m_12m_15m_male") {
  comps = snakemake@params$comparisons_CA1_age_3m_12m_15m
} else if (data_sub_set == "CA1_age=3m_12m_15m_female") {
  comps = snakemake@params$comparisons_CA1_age_3m_12m_15m
} else if (data_sub_set == "CA1_without_age=26m_28m"){
  comps = snakemake@params$comparisons_CA1_without_age_26m_28m
} else if (data_sub_set == "CA1_without_age=26m_28m_male"){
  comps = snakemake@params$comparisons_CA1_without_age_26m_28m
} else if (data_sub_set == "CA1_without_age=26m_28m_female"){
  comps = snakemake@params$comparisons_CA1_without_age_26m_28m
} else if (data_sub_set == "microglia"){
